defmodule :m_prettypr do
  ...
  Record.defrecord(:r_nest, :nest, n: :undefined,
                                d: :undefined)
  Record.defrecord(:r_beside, :beside, d1: :undefined,
                                  d2: :undefined)
  Record.defrecord(:r_above, :above, d1: :undefined,
                                 d2: :undefined)
  Record.defrecord(:r_sep, :sep, ds: :undefined, i: 0,
                               p: false)
  Record.defrecord(:r_float, :float, d: :undefined,
                                 h: :undefined, v: :undefined)
  Record.defrecord(:r_union, :union, d1: :undefined,
                                 d2: :undefined)
  ...
  def floating(d, h, v) when (is_integer(h) and
                          is_integer(v)) do
    r_float(d: d, h: h, v: v)
  end
  ...
  Record.defrecord(:r_c_best_nest, :c_best_nest, w: :undefined,
                                       r: :undefined, i: :undefined)
  Record.defrecord(:r_c_above_nest, :c_above_nest, d: :undefined, i: 0,
                                        c: :undefined)
  Record.defrecord(:r_c_beside, :c_beside, d: :undefined,
                                    c: :undefined)
  Record.defrecord(:r_c_text_beside, :c_text_beside, s: :undefined,
                                         c: :undefined)
  Record.defrecord(:r_c_sep_nest, :c_sep_nest, ds: :undefined,
                                      i: :undefined, p: :undefined,
                                      c: :undefined)
  Record.defrecord(:r_c_best_nest_or, :c_best_nest_or, w: :undefined,
                                          r: :undefined, i: :undefined,
                                          d: :undefined)
  Record.defrecord(:r_c_fit, :c_fit, c: :undefined)
  Record.defrecord(:r_c_float_beside, :c_float_beside, d: :undefined,
                                          h: :undefined, v: :undefined,
                                          c: :undefined)
  Record.defrecord(:r_c_float_above_nest, :c_float_above_nest, d: :undefined,
                                              h: :undefined, v: :undefined,
    ...
    case (c) do
        ...
        case (c1) do
            ...
            case (is_empty_string(s)) do
              false ->
                ...
                rewrite(beside(mktext(s),
                                 mksep([above(nil(), nest(n1 - w, d1)) | ds],
                                         n - w, r_c_sep_nest(c1, :p))),
                          c2)
              true ->
                case (r_c_sep_nest(c1, :p)) do
                  false ->
                    rewrite(expand_sep(above(nil(), nest(n1, d1)), ds, n),
                              c2)
                  true ->
                    rewrite(expand_par(above(nil(), nest(n1, d1)), ds, n),
                              c2)
                end
            end
          r_c_best_nest_or(w: w, r: r, i: n, d: d) ->
            ...
            case (:erlang.or(l + n > w, l > r)) do
              ...
              false ->
                rewrite(above(mktext(s), nest(n1, d1)),
                          r_c_best_nest(w: w, r: r, i: n))
            end
          ...
          r_c_above_nest(d: d2, i: n, c: c2) ->
            case (is_empty_string(s)) do
              false ->
                w = width(s)
                rewrite(beside(mktext(s),
                                 above(beside(nil(), d1), nest(n - w, d2))),
                          c2)
              true ->
      ...
      r_c_sep_nest(ds: ds, i: n, c: c1) ->
        case (is_empty_string(s)) do
          false ->
            rewrite(beside(mktext(s),
                             mksep([nil() | ds], n - width(s), r_c_sep_nest(c, :p))),
                      c1)
          true ->
    ...
    case (c) do
      ...
      r_c_text_beside(s: s, c: c1) ->
        rewrite(union(beside(mktext(s), d1),
                  ...
                  c1)
      r_c_sep_nest(ds: ds, i: n, c: c1) ->
        rewrite(union(mksep([d1 | ds], n, r_c_sep_nest(c, :p)),
  ...
  defp rewrite(r_float(d: d, h: h, v: v), c) do
    case (c) do
        ...
        case (c1) do
          ...
          r_c_float_above_nest(d: d2, h: h1, v: v1, i: n1, c: c2) when v1 > v ->
            rewrite(above(nest(n1, floating(d, h, v)),
                      ...
                      c2)
          r_c_float_above_nest(d: d2, h: h1, v: v1, i: _N1, c: c2) when (v1 == v and
                                                        h1 != h)
                                                     ->
      ...
      r_c_float_beside(d: d1, h: h1, v: v1, c: c1) ->
        cond do
          h1 > h ->
            rewrite(beside(floating(d, h, v), floating(d1, h1, v1)),
                      c1)
          v1 != v ->
            rewrite(above(floating(d, h, v), floating(d1, h1, v1)),
                      c1)
          true ->
